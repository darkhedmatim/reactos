...
BOOL CDonate::OnInitDialog() 
{
    ...
    //Set the target URL 
    m_Paypal.SetLinkUrl("https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=mattwu@163.com&item_name=Donation&return=https://sourceforge.net/projects/ext2fsd");
    //Enable showing the Tooltip
