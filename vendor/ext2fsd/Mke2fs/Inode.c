...
bool ext2_get_inode_lba(PEXT2_FILESYS Ext2Sys, ULONG no, LONGLONG *offset)
{
    ...
    {
        printf("Mke2fs: Inode value %lu was out of range in load_inode.(1-%ld)\n",
                        ...
                        ULONG newBlk, ULONG *dwRet, ULONG *off  )
{
    ...
    pData = (ULONG *) malloc(Ext2Sys->blocksize);
    ...
    else if (layer <= 3)
    {
        ...
        {
            bRet = false;
            printf("Mke2fs: ext2_expand_block: ... error recuise...\n");
            goto errorout;
        }
    }
                        ...
                        ULONG newBlk         )
{
    ...
    if (Index >= dwTotal)
    {
        printf("Mke2fs: ext2_expand_inode: beyond the maxinum size of an inode.\n");
        return false;
    }
...
bool ext2_get_block(PEXT2_FILESYS Ext2Sys, ULONG dwContent, ULONG Index, int layer, ULONG *dwRet)
{
    ...
    else if (layer <= 3)
    {
        ...
        {
            bRet = false;
            printf("Mke2fs: ext2_get_block: ... error recuise...\n");
            goto errorout;
        }
    }
...
bool ext2_block_map(PEXT2_FILESYS Ext2Sys, PEXT2_INODE inode, ULONG block, ULONG *dwRet)
{
    ...
    {
        printf("Mke2fs: ext2_block_map: beyond the size of the inode.\n");
        return false;
    }
                    ...
                    OUT PEXT2_BDL *ext2_bdl )
{
    ...
    *ext2_bdl = NULL;
    ...
    {
        printf("Mke2fs: ext2_build_bdl: beyond the file range.\n");
        return 0;
    }
...
*/
    ...
    if (nBlocks > 0)
    {
        ext2bdl = (PEXT2_BDL) malloc(sizeof(EXT2_BDL) * nBlocks);
                ...
                int filetype, char *name )
{
    ...
    buf = (char *) malloc (parent_inode.i_size);
