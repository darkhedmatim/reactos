  ...
  static ROPINFO KnownCodes[] =
    {
      ...
      { ROPCODE_PATINVERT,   "PATINVERT",  "D ^ (P & 0x00ffffff)",        1, 0, 1 },
      ...
      { ROPCODE_MERGECOPY,   "MERGECOPY",  "S & P & 0x00ffffff",        0, 1, 1 },
      { ROPCODE_SRCCOPY,     "SRCCOPY",    "S",            0, 1, 0 },
      { ROPCODE_SRCPAINT,    "SRCPAINT",   "D | S",        1, 1, 0 },
      { ROPCODE_PATCOPY,     "PATCOPY",    "P & 0x00ffffff",            0, 0, 1 },
      { ROPCODE_PATPAINT,    "PATPAINT",   "D | (~S) | (P & 0x00ffffff)", 1, 1, 1 },
