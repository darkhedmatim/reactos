...
typedef struct _SFsdData {
	...
	NPAGED_LOOKASIDE_LIST	ObjectNameLLHeader;
	NPAGED_LOOKASIDE_LIST	CCBLLHeader;
	NPAGED_LOOKASIDE_LIST	FCBLLHeader;
	NPAGED_LOOKASIDE_LIST	ByteLockLLHeader;
	NPAGED_LOOKASIDE_LIST	IrpContextLLHeader;
	void							*ObjectNameZone;
	void							*CCBZone;
	void							*FCBZone;
	void							*ByteLockZone;
